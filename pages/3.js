...
export default function Three() {
    return (
        <div>
            ...
            <div>
                <div data-w-id="5a03e825-bf98-6f5d-246c-8c324b2873d8" style={{ WebkitTransform: 'translate3d(0, 0, 0) scale3d(1.2, 1.2, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 0, 0) scale3d(1.2, 1.2, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 0, 0) scale3d(1.2, 1.2, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 0, 0) scale3d(1.2, 1.2, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)' }} className="modal-wrapper">
                    <div data-w-id="5a03e825-bf98-6f5d-246c-8c324b2873d9" className="div-block-32" />
                ...
                <div data-collapse="all" data-animation="default" data-duration={400} data-w-id="5a1030e5-17e8-8a1a-2de8-84f573ad8a9e" role="banner" className="navbar w-nav">
                    <div className="container-2 w-container">
                        ...
                        <nav role="navigation" className="w-nav-menu">
                            ...
                            <a href="#" className="w-button">Button Text</a>
                            <a href="#" className="w-nav-link">Contact</a>
                        </nav>
                        <a data-w-id="5a1030e5-17e8-8a1a-2de8-84f573ad8aab" href="#" className="button w-button">Get Early Access</a>
                    </div>
                </div>
                <div data-w-id="4b1f1ffc-60dd-1832-cae3-aa71a5f38c02" className="section">
                    <div className="columns w-row">
                        <div className="column-2 w-col w-col-4"><img src="images/Ayli-Logo-1_1Ayli Logo (1).png" width={67} alt="" className="image-47" /><img src="images/ayli-logo-no-icon-dark.png" width={67} sizes="(max-width: 767px) 100vw, 67px" srcSet="images/ayli-logo-no-icon-dark-p-500.png 500w, images/ayli-logo-no-icon-dark-p-800.png 800w, images/ayli-logo-no-icon-dark-p-1080.png 1080w, images/ayli-logo-no-icon-dark.png 1099w" alt="" className="image-23" />
                            <h1 className="heading-4">Earn Up To <span className="text-span">$1000<br />‍</span>A Year Browsing The Internet</h1>
                            ...
                            <div className="form-block-4 w-form">
                                <form id="email" name="email" data-name="Email Form" method="post" action="/api/submit" className="form-3"><input type="email" className="text-field-4 w-input" maxLength={256} name="email" data-name="Email 4" placeholder="Email" id="email-4" required /><input type="submit" defaultValue="Submit" data-wait="Please wait..." className="submit-button-3 w-button" /></form>
                                <div className="w-form-done">
                            ...
                            <p className="paragraph-16">By entering your email you agree to our <a href="privacy.html" target="_blank" className="link-2">privacy policy.</a>
                            </p>
                        </div>
                ...
                <div className="section-5">
                    <div className="columns-2 w-row">
                        ...
                        <div className="column-5 w-col w-col-7"><img src="images/AddBank_Popup_v2.png" width={426} data-w-id="67c0f58a-aac9-790e-70a0-de24a933c353" srcSet="images/AddBank_Popup_v2-p-500.png 500w, images/AddBank_Popup_v2.png 577w" sizes="(max-width: 479px) 100vw, 426px" alt="" className="image-14" /></div>
                    </div>
                </div>
                <div className="section-4">
                    <div className="columns-3 w-row">
                        <div className="column-9 w-col w-col-7"><img src="images/Demand-Site-landing-page-desktop-3.png" width={467} data-w-id="cd9dec11-e3f4-53d0-4310-8aecf3a28641" srcSet="images/Demand-Site-landing-page-desktop-3-p-500.png 500w, images/Demand-Site-landing-page-desktop-3.png 552w" sizes="(max-width: 479px) 90vw, (max-width: 767px) 467px, (max-width: 991px) 58vw, 467px" alt="" className="image-35" /></div>
                        <div className="column-11 w-clearfix w-col w-col-5">
                            <div className="div-block-5 spacing">
                                <div className="div-block-6" />
                                <div className="animation-div">
